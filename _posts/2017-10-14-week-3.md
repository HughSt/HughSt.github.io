...
across space from point data. These may be point level data (i.e. measurements
of something of interest at particular points) or point process data (i.e. 
occurences of events in a given area). When you load this week's libraries, it may prompt you
...
{% endhighlight %}
    ...
    ##           1   -17.51470 16.05666    1
    ##           2   -17.82175 16.15147    1
    ##           3   -17.78743 15.93465    1
    ##           4   -17.51352 15.83933    1
    ##           5   -17.63668 15.91185    1
    ##           7   -17.64459 16.16105    1
...
leaflet() %>% addTiles() %>% addCircleMarkers(data=CaseControl_SPDF, 
                                                  ...
                                                  radius = 2)
{% endhighlight %}
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/leaflet_case_control.png)<!-- -->
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->

{% highlight r %}
plot(density(Cases_ppp,0.1))
{% endhighlight %}

![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-10-2.png)<!-- -->

{% highlight r %}
plot(density(Cases_ppp,bw.ppl)) # automatic bandwidth selection based on cross-validation
{% endhighlight %}

![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-10-3.png)<!-- -->
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/leaflet_density.png)<!-- -->
...
associated with each point such as whether the point is a case (1) or control (0).
...
{% highlight r %}
# Obtaining probability of being a case
risk_est <-  relrisk(CaseControl_ppp) 
plot(risk_est)
{% endhighlight %}

![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->

{% highlight r %}
# Obtaining relative risk of being a case
rel_risk_est <-  relrisk(CaseControl_ppp, relative = TRUE)
plot(rel_risk_est)
{% endhighlight %}

![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/rel_risk_leaflet.png)<!-- -->
...
Get the Ethiopia Adm 1 level raster
...
plot(idw(ETH_malaria_data_ppp, power=1, at="pixels"),col=heat.colors(20), main="power = 1")
plot(idw(ETH_malaria_data_ppp, power=2, at="pixels"),col=heat.colors(20), main="power = 2") 
{% endhighlight %}

![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/idw_powers.png)<!-- -->
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/idw_cv_obs_pred.png)<!-- -->

Plot using leaflet. Again,

{% highlight r %}
# Convert to a raster
ETH_malaria_data_idw_raster <- raster(idw(ETH_malaria_data_ppp, power=optimal_power, at="pixels"),
                                     crs= crs(ETH_Adm_1))
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/idw_raster_leaflet.png)<!-- -->      
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-23-1.png)<!-- -->
...
= "2nd"` to the plot command to see the result after having regressed
...
to limit variogram estimation to half the maximum interpoint distance. If you want to include a 1st or 2nd order trend surface, you can pass in the argument `trend = "1st"` or `trend = "2nd"`.
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-24-2.png)<!-- -->
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-25-1.png)<!-- -->
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
Now that we have a variogram model depicting the covariance between pairs of
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-27-1.png)<!-- -->
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->

Generating cross-validated predictions is straightforward in geoR using
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week3_files/figure-gfm/unnamed-chunk-29-1.png)<!-- -->
...
* Generate a relative risk density estimate using [these](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/course_materials/week3/Assignment/cases_nairobi.csv) dummy case-control data from Nairobi, Kenya
* Compare interpolation accuracy using IDW and kriging using [these](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/course_materials/week3/Assignment/tanzania_uganda_hkprev.csv) hookworm infection prevalence data from Tanzania and Uganda 
