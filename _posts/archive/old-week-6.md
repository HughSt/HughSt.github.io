...
The slides for this week are [here](https://github.com/HughSt/HughSt.github.io/blob/master/course_materials/week6/Slides/spatial_regression.pptx). Besides the code displayed here, we will use some additional code to
...
cv_eth <- function(data, spamm_formula, ix_test_list) {
  ...
  for (i in 1:length(ix_test_list)) {
    ...
    train_set <- data[-c(ix_test_list[[i]]), ]
...
achieved when using just bioclim1.
...
your observations were made in ‘desert’. Once you've had a go, see 
[here](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/course_materials/week6/assignment/cheat_sheet.R) for a cheat sheet.
