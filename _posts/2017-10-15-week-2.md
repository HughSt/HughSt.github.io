...
exercise, we are going to use the admin 2 boundaries for Ethiopia
...
{% highlight r %}
ETH_Adm_1_Amhara <- subset(ETH_Adm_1, ETH_Adm_1$NAME_1=="Amhara") #OR ETH_Adm_1[ETH_Adm_1=="Amhara",] will also work
ETH_Adm_1_Amhara
{% endhighlight %}
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week2_files/figure-gfm/leaflet_admin1_prev.png)<!-- -->
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week2_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week2_files/figure-gfm/unnamed-chunk-17-2.png)<!-- -->

{% highlight r %}
# For a break down of the classes in Ethiopia aka how often each land use type occurs in Ethiopia
...
see [here](https://github.com/HughSt/HughSt.github.io/blob/master/_posts/raster_resampling.md). The default method is bilinear interpolation,
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week2_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week2_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
...
ETH_malaria_data_SPDF # now has extra `elev` variable
{% endhighlight %}
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week2_files/figure-gfm/unnamed-chunk-27-1.png)<!-- -->
...
![](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/_posts/week2_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->
...
in meters. Its important to use meters as degrees are not a good measure of distance. 1 degree at the equator is a larger distance than nearer the poles. The 'distm' function works OK if you don't have too many pairs of points,
but the more you have, the longer your machine will be crunching data. Depending on your machine, this next step might take a while. You can skip to the next section to get a more efficient, but potentially less accurate, method. 
...
## Assignment
1) Generate a map and table showing prevalence of infection at admin 2 level.

2) Generate some exploratory plots to look at the relationship between land class and infection prevalance. How might you go about this given that land class is categorical as opposed to continuous? Hint: check out [boxplots](https://www.statmethods.net/graphs/boxplot.html). You might also want to reclassify land class using the broader categories as outlined in the final table (Appendix II – LCCS & the GlobCover legend) [here](http://due.esrin.esa.int/files/GLOBCOVER2009_Validation_Report_2.2.pdf)

3) Find 2 more interesting layers/variables (not from those used in the class) to relate to the survey data. Generate some plots to explore the relationships.  You can find a raster and extract, or generate your own variable (i.e. distance to something). Hint: Check out the `getData` function from the raster package where you can access bioclimatic data. The WHO also recently published a [database of georefenced health facilities in Africa](https://www.who.int/malaria/areas/surveillance/public-sector-health-facilities-ss-africa/en/) which might be useful. 
