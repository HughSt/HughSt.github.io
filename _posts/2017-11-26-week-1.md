...
## Assignment
Try making a nice leaflet map (or maps) of some (health) data of your choice. Think about optimal color schemes and include popups. Make sure you include a well titled legend (or set of legends). You can use your own data if you have it, otherwise try one of these sources of data:
