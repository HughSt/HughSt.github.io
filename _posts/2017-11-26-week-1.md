...
![](_posts/week1_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
![](_posts/week1_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
![](_posts/week1_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](_posts/week1_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->

``` r
spplot(BF_malaria_data_SPDF, zcol = "infection_prevalence")
```

![](_posts/week1_files/figure-gfm/unnamed-chunk-7-2.png)<!-- -->
...
![](_posts/week1_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](_posts/week1_files/figure-gfm/leaflet1.png)

    # Or choose another basemap
    basemap <- leaflet() %>% addProviderTiles("Esri.WorldImagery")
    basemap
    
![](_posts/week1_files/figure-gfm/leaflet_esri.png)
...
![](_posts/week1_files/figure-gfm/leaflet_admin1.png)
    
    # to change the colors/line weight
    basemap %>% addPolygons(data=BF_Adm_1, color = "red", 
                            weight = 1, fillOpacity = 0.2)

![](_posts/week1_files/figure-gfm/leaflet_admin1_red.png)

    #You can also add popups
    basemap %>% addPolygons(data=BF_Adm_1, 
                            popup = BF_Adm_1$NAME_1)
                            
![](_posts/week1_files/figure-gfm/leaflet_admin1_popup.png)
...
![](_posts/week1_files/figure-gfm/leaflet_admin1_points.png)                                 
...
![](_posts/week1_files/figure-gfm/leaflet_admin1_points_wes.png)  
...
![](_posts/week1_files/figure-gfm/leaflet_admin1_quintiles.png)  
...
![](_posts/week1_files/figure-gfm/leaflet_admin_quintile_popup.png)  
...
![](_posts/week1_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->

Alternatively, you can use leaflet

    basemap %>% addRasterImage(elev)

![](_posts/week1_files/figure-gfm/leaflet_raster.png)  
...
![](_posts/week1_files/figure-gfm/leaflet_raster_topo.png)  
