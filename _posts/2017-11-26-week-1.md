...
[lecture](https://github.com/HughSt/HughSt.github.io/blob/master/course_materials/week1/Slides/Spatial%20Epi%20intro%202019.pptx) will focus on some of the concepts behind spatial
...
[GitHub](https://github.com/HughSt/HughSt.github.io/blob/master/course_materials/week1/Lab_files/Data/ETH_Adm1_shapefile.zip),
...
“elev\_ETHA.tif” file from this week’s data, you would use the
following:
...
## Assignment
Try making a nice leaflet map (or maps) of some (health) data of your choice. You can use your own data if you have it, otherwise try one of these sources of data:
...
Bear in mind leaflet can’t handle loads of points/polygons. As for all assignments, please submit an html file of your rmarkdown. More information about rmarkdown can be found [here](https://rmarkdown.rstudio.com/) or in the [rmarkdown cheatsheet](https://github.com/HughSt/HughSt.github.io/blob/master/course_materials/rmarkdown-cheatsheet.pdf)
