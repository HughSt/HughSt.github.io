...
This post provides an introduction to methods for exploring clustering in different types of spatial data. The approaches will be explored together in R, followed by an opportunity to adapt the code and run the analysis yourself. We will end by using SatScan to identify local clusters of malaria infection. Slides for this week can be found [here](https://github.com/HughSt/HughSt.github.io/blob/master/course_materials/week4/Slides/Spatial%20Clustering%202019.pptx)
...
## Assignment
Test for clustering in [these](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/course_materials/week3/Assignment/cases_nairobi.csv) dummy case-control data from Nairobi and if present, over what scale it occurs.