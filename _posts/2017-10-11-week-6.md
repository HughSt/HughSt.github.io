...
In this case, it looks like there is no evidence that bioclim1 is
...
It is also useful to check how well your fitted values (i.e. predictions at your
...
[Week 4](https://hughst.github.io/week-4/). The table and spatial autocorrelogram below 
suggest that there is spatial
...
idea behind Spatial Statistics is to understand and characterize this
...
Statistics deal with problems where neighbouring values are expected to be more
alike than things further apart from each other.

When we want to measure how much two variables change together, we use the
...
similarity between values in space as a function of the distance between
...
means that the more distance between a pair of points, the weaker the covariance
between them.
...
[Chapter 15](https://www.sagepub.com/sites/default/files/upm-binaries/21121_Chapter_15.pdf)
